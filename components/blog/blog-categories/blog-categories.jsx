    ...
    <section className='sm:container sm:p-2 mx-auto mt-16'>
      ...
      <div className="relative">
        ...
        <div className=' flex items-center gap-10 px-10 overflow-x-auto' ref={scrollRef}>
          {category.map((item) => (<div key={uuidv7()} onClick={() => handleType(item.category)} className={` mx-auto cursor-pointer w-fit group hover:text-red-500 ${item.category === type ? 'text-red-500' : ''} text-center flex flex-col items-center justify-center`}>

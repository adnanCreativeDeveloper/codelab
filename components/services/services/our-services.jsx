          ...
          <div className='p-2 bg-white border-2 border-gray-200 md:p-5 rounded-xl md:rounded-3xl'>
            ...
            <div className='relative mt-5'>
              <Image placeholder='blur'
                blurDataURL={placeholders['/images/services/services-card/web-designing.jpg']} width={400} height={600} className='w-full h-[400px] md:h-[900px] object-cover rounded-xl md:rounded-3xl' src='/images/services/services-card/web-designing.jpg' alt='Web Designing' />
            </div>
          </div>
        </Animation>
          ...
          <Animation>
            <div className='p-2 bg-white border-2 border-gray-200 md:p-5 rounded-xl md:rounded-3xl'>
              <div className='relative mb-5'>
                <Image placeholder='blur'
                  blurDataURL={placeholders['/images/services/services-card/graphic-designing.jpeg']} width={400} height={300} src={'/images/services/services-card/graphic-designing.jpeg'} className='w-full h-[400px] md:h-[315px] lg:h-[360px] object-cover rounded-xl md:rounded-3xl' />
              </div>
              <div className='px-2 pt-1 sm:p-0'>
          ...
          <Animation>
            <div className='grid grid-cols-1 gap-5 p-2 bg-white border-2 border-gray-200 md:p-5 rounded-xl md:rounded-3xl lg:grid-cols-2'>
              <div className="relative">
                <Image placeholder='blur'
                  blurDataURL={placeholders['/images/services/services-card/web-development.jpg']} width={400} height={300} src={'/images/services/services-card/web-development.jpg'} className='w-full h-[400px] md:h-[200px] lg:h-[476px] object-cover rounded-xl md:rounded-3xl' />
              </div>
              <div className='px-2 pt-1 sm:p-0'>
